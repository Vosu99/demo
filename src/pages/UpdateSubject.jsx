           ...
           <div class="col-sm-3 mt-5 mb-4 text-gred">
              <div className="search">
                <form class="form-inline">
                 <input class="form-control mr-sm-2"  style={{width:"100%",height:"100%"}} type="search" placeholder="Search Subjects" aria-label="Search"/>
                 <Button  class="mt-4 btn btn-primary"> Search</Button>
                </form>
              </div>    
              </div>  
              <div class="col-sm-3 offset-sm-2 mt-5 mb-4 text-gred" style={{color:"green"}}><h2><b>Subjects Details</b></h2></div>
